...
interface BoardState{
    ...
    image: File | null;
    addTask: (todo: string, columnId: TypedColumn, userID: string, image?: File|null) => void;
...
export const useBoardStore = create<BoardState>((set, get) => ({
    ...
    addTask: async (todo: string, columnId: TypedColumn, userID: string, image?: File|null) => {
